...
function App() {
  ...
  const isProductDetail = !!matchPath(
    { path: '/product-recommendation/detail/:id', end: true },
    pathname
  );

  return (
    <div className="mx-auto max-w-[412px] min-h-screen bg-white overflow-x-hidden">
      {isProductDetail ? <DetailHeader /> : <Header />}
      ...
      <Layout>
        <Routes>
          ...
          <Route
            path="/couple/goal-simulation-input"
            element={<GoalSimulationInputPage />}
          />
          <Route
            path="/couple/goal-simulation-result"
            element={<GoalSimulationResultPage />}
          />
          ...
          <Route
            ...
            element={<ProductRecommendationDashboardPage />}
          />
          <Route
            path="/product-recommendation/detail/:id"
            element={<ProductRecommendationDetailPage />}
          />
          ...
          <Route
            ...
            element={<WeddingGuideDashboardPage />}
          />
